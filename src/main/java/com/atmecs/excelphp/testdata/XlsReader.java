...
import org.apache.poi.xssf.usermodel.XSSFWorkbook;
	...
	public class XlsReader {
		...
		public Object[][] readExcelData(String sheetName) throws IOException {
			...
			/*
			 * for (int colIndex = 0; colIndex < cellCount; colIndex++) { String value =
			 * sh.getRow(rowIndex).getCell(colIndex).getStringCellValue(); data[rowIndex -
			 * 1][colIndex] = value; }
			 */
				for (int colIndex = 0; colIndex < cellCount; colIndex++)
				{
				XSSFCell cell = sh.getRow(rowIndex).getCell(colIndex);
